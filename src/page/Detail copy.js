                ...
                <div className='container'>
                    <div className='row'>
                        ...
                        <div className='col-md-6'>
                            ...
                            <h2 className='text-white mb-3'>{foundProduct.price}</h2>
                            ...
                            <div className='row mb-4'>
                                <div className='col-md-6'>
                                    <button className='btn btn-light w-100 pt-3 pb-0'><strong>Mua trả góp 0%</strong><p>Qua công ty tài chính</p></button>
                                </div>
                                <div className='col-md-6'>
