...
function Mac() {
  ...
  return (
    <div className='container-fluid ps-0 pe-0 home-page-bg'>
      ...
      <div className="col d-flex d-row justify-content-center">
        <div className="text-white mt-4" style={{fontSize: '35px'}}><i className="fa-brands fa-apple"></i> iMac</div>
      </div>
      ...
      <div id="carouselExampleIndicators" className="carousel slide w-75 mt-4 mb-4 ms-auto me-auto" data-bs-ride="true">
        ...
        <div className="row-sm">
          <div className="col-sm d-flex d-row justify-content-center flex-wrap ms-auto me-auto">
              {macs.map((mac, key) => {
              return(<Link className='nav-link mt-3 mb-5 ms-2 me-2' to={`/mac/${mac.id}`}><div className="card bg-dark" style={{width: "18rem"}} key={key}>
                      <img className="home-page-img-mac" src={mac.image}></img>
                      <div className="card-body">
                        <h5 className="card-title text-white text-center">{mac.name}</h5>
                        <h6 className="card-title text-white text-center">{mac.store}</h6>
                        <p className="text-white text-center">{mac.price.toLocaleString('en-US', {
