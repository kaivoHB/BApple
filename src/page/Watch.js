...
function Watch() {
  ...
  const watchs = data.products.Watch;
  ...
  return (
    <div className='home-page-bg'>
      ...
      <div className="col d-flex d-row justify-content-center">
        <div className="text-white mt-4" style={{fontSize: '35px'}}><i className="fa-brands fa-apple"></i> Apple Watch</div>
      </div>
      ...
      <div id="carouselExampleIndicators" className="carousel slide w-75 mt-4 mb-4 ms-auto me-auto" data-bs-ride="true">
        ...
        <div className="row">
          <div className="col d-flex d-row justify-content-center flex-wrap ms-auto me-auto">
              {watchs.map((watch, key) => {
              return(<Link className='nav-link mt-3 mb-5 ms-2 me-2' to={`/watch/${watch.id}`}><div className="card bg-dark" key={key}>
                      <img className="home-page-img-mac" src={watch.image}></img>
                      <div className="card-body">
                        <h5 className="card-title text-white text-center">{watch.name}</h5>
                        <h6 className="card-title text-white text-center">{watch.store}</h6>
                        <p className="text-white text-center">{watch.price.toLocaleString('en-US', {
